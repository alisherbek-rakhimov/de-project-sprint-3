...
Пошел по другому пути, чем в проекте, который делал на курсе.
![img.png](img.png)

Первым делом инициализация если staging таблицы пусты. 8 дней на обработку, 1 для загрузки инициализации. остальные 7 дней на инкрементальную загрузку.